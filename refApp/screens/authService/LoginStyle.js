...
export default StyleSheet.create({
    ...
    loginButton: {
        ...
        // backgroundColor: this.state.emailInput.trim() === '' || this.state.passwordInput.trim() === '' ? ColorConstants.secondaryThemeColor : ColorConstants.primaryThemeGradient
    },
    ...
    bottomContainer: {
        // height: Platform.OS === 'ios' ? "100%" : verticalScale(369),
