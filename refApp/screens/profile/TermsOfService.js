...
export default class TermsOfService extends Component {
    ...
    componentDidMount() {
      ...
      let dataIndex = this.props.route.params.helpCenterData.findIndex((item) => item.id === 6);
      if(dataIndex !== -1)
    ...
    setNavigationHeaderConfiguration = () => {
        this.props.navigation.setOptions({
            ...
            headerTitle: () => (<View><Text style={styles.headerTitleStyle}>Terms Of Service</Text></View>),
