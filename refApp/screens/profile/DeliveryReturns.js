...
import R from '../../R';
import styles from './DeliveryReturnsStyle';
import { verticalScale } from '../../utils/Scale';
import { WebView } from 'react-native-webview';
import FocusAwareStatusBar from '../../components/FocusAwareStatusBar';

export default class DeliveryReturns extends Component {
    ...
    componentDidMount() {
      ...
      let dataIndex = this.props.route.params.helpCenterData.findIndex((item) => item.id === 4);
      if(dataIndex !== -1)
    ...
    setNavigationHeaderConfiguration = () => {
        this.props.navigation.setOptions({
            ...
            headerTitle: () => (<View><Text style={styles.headerTitleStyle}>Delivery & Returns</Text></View>),
