...
import R from '../../R';
import styles from './HowItWorksStyle';
...
export default class HowItWorks extends Component {
    ...
    componentDidMount() {
      ...
      let dataIndex = this.props.route.params.helpCenterData.findIndex((item) => item.id === 3);
      if(dataIndex !== -1)
    ...
    setNavigationHeaderConfiguration = () => {
        this.props.navigation.setOptions({
            ...
            headerTitle: () => (<View><Text style={styles.headerTitleStyle}>How it works</Text></View>),
